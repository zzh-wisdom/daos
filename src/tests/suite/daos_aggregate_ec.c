...
test_partial_stripe(struct ec_agg_test_ctx *ctx)
{
	...
	D_PRINT("Check Full Stripe Pool Space\n");
	sleep(30);
	...
	D_PRINT("Check Pool Space after overwrite\n");
	sleep(60);
...
{
        return test_setup(statep, SETUP_POOL_CONNECT, true, 17179869184ULL,
                          NUM_SERVERS, NULL);
}
