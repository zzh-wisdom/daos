...
class CopyBasicsTest(DataMoverTestBase):
    ...
    def test_copy_types_dcp(self):
        ...
        :avocado: tags=copy_basics,copy_types_dcp
        """
    ...
    def test_copy_auto_create_dest_dcp(self):
        ...
        :avocado: tags=all,daily_regression
        :avocado: tags=datamover,dcp
        :avocado: tags=copy_basics,copy_auto_create_dest_dcp
        """
        self.set_tool("DCP")
        ...
        self.write_location("DAOS", "/", pool1, container1)
        ...
        self.run_datamover(
            ...
            "DAOS", "/", pool1, new_uuid)
        self.read_verify_location("DAOS", "/", pool1, new_uuid)
        ...
        self.run_datamover(
            ...
            "DAOS", "/", pool1, container1,
            "DAOS", "/", pool2, new_uuid)
        self.read_verify_location("DAOS", "/", pool2, new_uuid)

    def test_copy_subsets_dcp(self):
        """
        Test Description:
    ...
    def _copy_subsets(self, tool):
        ...
        #   [param_type, path, pool, cont]
        for (test_desc, src, dst) in copy_list:
            src_type, src_path, src_pool, src_cont = src
            dst_type, dst_path, dst_pool, dst_cont = dst
            self.run_datamover(
                test_desc,
